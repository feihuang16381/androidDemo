...
public class SwipeBackLayout extends FrameLayout {
    ...
    private void init() {
        ...
        setShadow(com.cqut.fragmentation_swipeback.R.drawable.shadow_left, EDGE_LEFT);
    ...
    public void setEdgeOrientation(@EdgeOrientation int orientation) {
        ...
        if (orientation == EDGE_RIGHT || orientation == EDGE_ALL) {
            setShadow(com.cqut.fragmentation_swipeback.R.drawable.shadow_right, EDGE_RIGHT);
        }
    }
